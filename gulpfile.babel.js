...
function inline() {
  return gulp.src('templates/**/*.tpl.html')
    .pipe($.if(PRODUCTION, inliner('./mail.css')))
    .pipe(gulp.dest('templates'));
}
...
function watch() {
  gulp.watch('src/templates/**/*.tpl.html').on('all', gulp.series(pages, inline, browser.reload));
...
function inliner(css) {
  ...
  var pipe = lazypipe()
    ...
    .pipe($.replace, '<link rel="stylesheet" type="text/css" href="css/mail.css">', '')
    .pipe($.htmlmin, {
...
function aws() {
  ...
  return gulp.src('./templates/assets/img/*')
...
function litmus() {
  ...
  return gulp.src('templates/**/*.tpl.php')
...
function zip() {
  ...
  var htmlFiles = getHtmlFiles(templates);

  var moveTasks = htmlFiles.map(function(file){
    var sourcePath = path.join(templates, file);
